    ...
    if os.stat(dirname+"/error.txt").st_size != 0:
        ...
        if index != -1:
            ...
            if termination_code == "9":
                input_f = Files(type='inputfile',submission=submission,filepath=inputfilename,errortype='Time OUT',runtime='2.0',memoryused='-')
                input_f.save()
...
def submit_code(request):
    ...
    counter = 1
    inputfilecount = 18#request.POST.get['inputfilecount']
